...
# The appraiser's delivered reports and his own folder template. Private material: it
...
has_template = pytest.mark.skipif(
    ...
    reason="the appraiser's folder template is private and not in this repository",
)
